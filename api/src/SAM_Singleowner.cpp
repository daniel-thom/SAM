...
SAM_EXPORT SAM_Singleowner SAM_Singleowner_construct(const char* def, SAM_error* err){
	SAM_Singleowner result = nullptr;
...
SAM_EXPORT int SAM_Singleowner_execute(SAM_Singleowner data, int verbosity, SAM_error* err){
	int n_err = 0;
	translateExceptions(err, [&]{
		n_err += SAM_module_exec("singleowner", data, verbosity, err);
	});
	return n_err;
}
...
SAM_EXPORT double* SAM_Singleowner_SystemCosts_om_capacity1_aget(SAM_Singleowner ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Singleowner", "om_capacity1");
	});
	return result;
}
...
SAM_EXPORT double SAM_Singleowner_SystemCosts_om_capacity1_nameplate_nget(SAM_Singleowner ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "om_capacity1_nameplate", &result))
		make_access_error("SAM_Singleowner", "om_capacity1_nameplate");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Singleowner_SystemCosts_om_capacity2_aget(SAM_Singleowner ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Singleowner", "om_capacity2");
	});
	return result;
}
...
SAM_EXPORT double SAM_Singleowner_SystemCosts_om_capacity2_nameplate_nget(SAM_Singleowner ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "om_capacity2_nameplate", &result))
		make_access_error("SAM_Singleowner", "om_capacity2_nameplate");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Singleowner_SystemCosts_om_fixed1_aget(SAM_Singleowner ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Singleowner", "om_fixed1");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Singleowner_SystemCosts_om_fixed2_aget(SAM_Singleowner ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Singleowner", "om_fixed2");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Singleowner_SystemCosts_om_production1_aget(SAM_Singleowner ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Singleowner", "om_production1");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Singleowner_SystemCosts_om_production2_aget(SAM_Singleowner ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Singleowner", "om_production2");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Singleowner_SystemCosts_om_replacement_cost1_aget(SAM_Singleowner ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Singleowner", "om_replacement_cost1");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Singleowner_SystemCosts_om_replacement_cost2_aget(SAM_Singleowner ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Singleowner", "om_replacement_cost2");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Singleowner_ReturnOnEquity_roe_input_aget(SAM_Singleowner ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Singleowner", "roe_input");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Singleowner_Outputs_cf_lcog_costs_aget(SAM_Singleowner ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Singleowner", "cf_lcog_costs");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Singleowner_Outputs_cf_return_on_equity_aget(SAM_Singleowner ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Singleowner", "cf_return_on_equity");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Singleowner_Outputs_cf_return_on_equity_dollars_aget(SAM_Singleowner ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Singleowner", "cf_return_on_equity_dollars");
	});
	return result;
}
...
SAM_EXPORT double* SAM_Singleowner_Outputs_cf_return_on_equity_input_aget(SAM_Singleowner ptr, int* length, SAM_error *err){
	...
	if (!result)
		make_access_error("SAM_Singleowner", "cf_return_on_equity_input");
	});
	return result;
}
...
SAM_EXPORT double SAM_Singleowner_Outputs_lcog_nget(SAM_Singleowner ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "lcog", &result))
		make_access_error("SAM_Singleowner", "lcog");
	});
	return result;
}
...
SAM_EXPORT double SAM_Singleowner_Outputs_lcog_depr_nget(SAM_Singleowner ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "lcog_depr", &result))
		make_access_error("SAM_Singleowner", "lcog_depr");
	});
	return result;
}
...
SAM_EXPORT double SAM_Singleowner_Outputs_lcog_loan_int_nget(SAM_Singleowner ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "lcog_loan_int", &result))
		make_access_error("SAM_Singleowner", "lcog_loan_int");
	});
	return result;
}
...
SAM_EXPORT double SAM_Singleowner_Outputs_lcog_om_nget(SAM_Singleowner ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "lcog_om", &result))
		make_access_error("SAM_Singleowner", "lcog_om");
	});
	return result;
}
...
SAM_EXPORT double SAM_Singleowner_Outputs_lcog_roe_nget(SAM_Singleowner ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "lcog_roe", &result))
		make_access_error("SAM_Singleowner", "lcog_roe");
	});
	return result;
}
...
SAM_EXPORT double SAM_Singleowner_Outputs_lcog_wc_int_nget(SAM_Singleowner ptr, SAM_error *err){
	...
	if (!ssc_data_get_number(ptr, "lcog_wc_int", &result))
		make_access_error("SAM_Singleowner", "lcog_wc_int");
	});
	return result;
}
