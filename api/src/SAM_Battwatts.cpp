...
SAM_EXPORT void SAM_Battwatts_Common_system_use_lifetime_output_nset(SAM_Battwatts ptr, double number, SAM_error *err){
	translateExceptions(err, [&]{
...
SAM_EXPORT double SAM_Battwatts_Common_system_use_lifetime_output_nget(SAM_Battwatts ptr, SAM_error *err){
	double result;
	translateExceptions(err, [&]{
