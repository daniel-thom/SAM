...
extern "C"
{
	 ...
	 * required if: *
	 */
	SAM_EXPORT void SAM_Equpartflip_SolutionMode_ppa_price_input_aset(SAM_Equpartflip ptr, double* arr, int length, SAM_error *err);
	...
	SAM_EXPORT double* SAM_Equpartflip_SolutionMode_ppa_price_input_aget(SAM_Equpartflip ptr, int* length, SAM_error *err);
