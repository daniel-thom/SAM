...
{
	return PySAM_array_getter(SAM_Levpartflip_SolutionMode_ppa_price_input_aget, self->data_ptr);
}

static int
SolutionMode_set_ppa_price_input(SolutionModeObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Levpartflip_SolutionMode_ppa_price_input_aset, self->data_ptr);
}
