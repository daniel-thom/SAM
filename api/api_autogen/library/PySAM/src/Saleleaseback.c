...
{
	return PySAM_array_getter(SAM_Saleleaseback_DHF_ppa_price_input_aget, self->data_ptr);
}

static int
DHF_set_ppa_price_input(DHFObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Saleleaseback_DHF_ppa_price_input_aset, self->data_ptr);
}
