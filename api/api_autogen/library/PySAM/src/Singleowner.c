...
{
	return PySAM_array_getter(SAM_Singleowner_PPAPrice_ppa_price_input_aget, self->data_ptr);
}

static int
PPAPrice_set_ppa_price_input(PPAPriceObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Singleowner_PPAPrice_ppa_price_input_aset, self->data_ptr);
}
...
CapacityPayments_new(SAM_Singleowner data_ptr)
{
	...
	CapacityPaymentsObject* CapacityPayments_obj = (CapacityPaymentsObject*)new_obj;

	CapacityPayments_obj->data_ptr = data_ptr;
...
static PyObject *
CapacityPayments_assign(CapacityPaymentsObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
...
static PyObject *
CapacityPayments_export(CapacityPaymentsObject *self, PyObject *args)
{
...
static PyTypeObject CapacityPayments_Type = {
		...
		sizeof(CapacityPaymentsObject),          /*tp_basicsize*/
		0,                          /*tp_itemsize*/
		/* methods */
		0,    /*tp_dealloc*/
		0,                          /*tp_print*/
...
FinancialGrid_new(SAM_Singleowner data_ptr)
{
	...
	FinancialGridObject* FinancialGrid_obj = (FinancialGridObject*)new_obj;

	FinancialGrid_obj->data_ptr = data_ptr;
...
static PyObject *
FinancialGrid_assign(FinancialGridObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
...
static PyObject *
FinancialGrid_export(FinancialGridObject *self, PyObject *args)
{
...
static PyObject *
FinancialGrid_get_grid_curtailment_price(FinancialGridObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Singleowner_FinancialGrid_grid_curtailment_price_aget, self->data_ptr);
}

static int
FinancialGrid_set_grid_curtailment_price(FinancialGridObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Singleowner_FinancialGrid_grid_curtailment_price_aset, self->data_ptr);
}

static PyObject *
FinancialGrid_get_grid_curtailment_price_esc(FinancialGridObject *self, void *closure)
{
	return PySAM_double_getter(SAM_Singleowner_FinancialGrid_grid_curtailment_price_esc_nget, self->data_ptr);
}

static int
FinancialGrid_set_grid_curtailment_price_esc(FinancialGridObject *self, PyObject *value, void *closure)
{
...
static PyTypeObject FinancialGrid_Type = {
		...
		sizeof(FinancialGridObject),          /*tp_basicsize*/
		0,                          /*tp_itemsize*/
		/* methods */
		0,    /*tp_dealloc*/
		0,                          /*tp_print*/
...
static PyObject *
Common_get_annual_energy_pre_curtailment_ac(CommonObject *self, void *closure)
{
	return PySAM_double_getter(SAM_Singleowner_Common_annual_energy_pre_curtailment_ac_nget, self->data_ptr);
}

static int
Common_set_annual_energy_pre_curtailment_ac(CommonObject *self, PyObject *value, void *closure)
{
...
static PyObject *
Outputs_get_cf_capacity_payment(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_cf_curtailment_value(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_cf_energy_curtailed(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_npv_capacity_revenue(OutputsObject *self, void *closure)
{
	return PySAM_double_getter(SAM_Singleowner_Outputs_npv_capacity_revenue_nget, self->data_ptr);
}

static PyObject *
Outputs_get_npv_curtailment_revenue(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_npv_fed_pbi_income(OutputsObject *self, void *closure)
{
	return PySAM_double_getter(SAM_Singleowner_Outputs_npv_fed_pbi_income_nget, self->data_ptr);
}

static PyObject *
Outputs_get_npv_oth_pbi_income(OutputsObject *self, void *closure)
{
