...
{
	return PySAM_double_getter(SAM_Battwatts_Common_system_use_lifetime_output_nget, self->data_ptr);
}

static int
Common_set_system_use_lifetime_output(CommonObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_Battwatts_Common_system_use_lifetime_output_nset, self->data_ptr);
}
