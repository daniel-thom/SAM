...
{
	return PySAM_array_getter(SAM_Pvsamv1_TimeOfDelivery_ppa_price_input_aget, self->data_ptr);
}

static int
TimeOfDelivery_set_ppa_price_input(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Pvsamv1_TimeOfDelivery_ppa_price_input_aset, self->data_ptr);
}
