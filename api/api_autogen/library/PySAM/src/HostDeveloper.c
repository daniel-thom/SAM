...
{
	return PySAM_array_getter(SAM_HostDeveloper_PPAPrice_ppa_price_input_aget, self->data_ptr);
}

static int
PPAPrice_set_ppa_price_input(PPAPriceObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_PPAPrice_ppa_price_input_aset, self->data_ptr);
}
